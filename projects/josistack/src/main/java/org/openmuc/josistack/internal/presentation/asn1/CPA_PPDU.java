...
public final class CPA_PPDU {
    ...
    public final static class SubSeq_normal_mode_parameters {
        ...
        public SubSeq_normal_mode_parameters(BerBitString protocol_version, BerOctetString responding_presentation_selector, Result_list
                presentation_context_definition_result_list, BerBitString presentation_requirements, BerBitString
                user_session_requirements, User_data user_data) {
            id = identifier;
