...
public final class CP_type {
    ...
    public final static class SubSeq_normal_mode_parameters {
        ...
        public SubSeq_normal_mode_parameters(BerBitString protocol_version, BerOctetString calling_presentation_selector, BerOctetString
                called_presentation_selector, Context_list presentation_context_definition_list, Default_context_name
                default_context_name, BerBitString presentation_requirements, BerBitString user_session_requirements, User_data user_data) {
            id = identifier;
