...
public final class TConnection {
    ...
    TConnection(Socket socket, int maxTPduSizeParam, int messageTimeout, int messageFragmentTimeout, ServerThread serverThread) throws
            IOException {
     ...
     * @throws SocketTimeoutException if a messageFragmentTimeout is thrown by the socket while receiving the remainder of a message
     * @throws IOException            if an ErrorPDU (ER) was received, any syntax error in the received message header was detected or the
     *                                tSduBuffer is too small to hold the complete PDU.
     * @throws TimeoutException       this exception is thrown if the first byte of new message is not received within the message timeout.
     */
