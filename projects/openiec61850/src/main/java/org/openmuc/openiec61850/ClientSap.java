...
public final class ClientSap {
    ...
    private byte[] servicesSupportedCalling = new byte[]{(byte) 0xee, 0x1c, 0, 0, 0x04, 0x08, 0, 0, 0x79, (byte) 0xef, 0x18};
     ...
     *
     * @param tSelRemote the remote/called T-SEL. If null the T-SEL will be omitted. No maximum size is defined by the
     *                   standard.
     */
     ...
     *
     * @param tSelLocal the local/calling T-SEL. If null the T-SEL will be omitted. No maximum size is defined by the
     *                  standard.
     */
     ...
     * @param authenticationParameter an optional authentication parameters that is transmitted. It will be omitted if equal to null.
     ...
     */
    public ClientAssociation associate(InetAddress address, int port, String authenticationParameter, ClientEventListener reportListener)
            throws IOException {
     ...
     * @throws IOException if any kind of error occurs trying build up the association
     */
    public ClientAssociation associate(InetAddress address, int port, String authenticationParameter, InetAddress localAddr, int
            localPort, ClientEventListener reportListener) throws IOException {
        ...
        ClientAssociation clientAssociation = new ClientAssociation(address, port, localAddr, localPort, authenticationParameter, acseSap,
                                                                    proposedMaxMmsPduSize, proposedMaxServOutstandingCalling,
                                                                    proposedMaxServOutstandingCalled, proposedDataStructureNestingLevel,
                                                                    servicesSupportedCalling, responseTimeout, messageFragmentTimeout,
                                                                    reportListener);
