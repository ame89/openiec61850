...
import org.openmuc.openiec61850.internal.mms.asn1.*;
...
public final class ClientAssociation {
            ...
            try {
                while (true) {
                    ...
                    if (decodedResponsePdu.unconfirmedPdu != null) {
                        if (decodedResponsePdu.unconfirmedPdu.unconfirmedService.informationReport.variableAccessSpecification
                                .listOfVariable != null) {
        ...
        private void disconnect() {
            synchronized (this) {
                if (closed == false) {
                    ...
                    try {
                        incomingResponses.put(new MmsPdu(new ConfirmedRequestPdu(), null, null, null, null, null, null, null, null));
    ...
    ClientAssociation(InetAddress address, int port, InetAddress localAddr, int localPort, String authenticationParameter, ClientAcseSap
            acseSap, int proposedMaxMmsPduSize, int proposedMaxServOutstandingCalling, int proposedMaxServOutstandingCalled, int
            proposedDataStructureNestingLevel, byte[] servicesSupportedCalling, int responseTimeout, int messageFragmentTimeout,
    ...
    private static ServiceError mmsDataAccessErrorToServiceError(BerInteger dataAccessError) {
        ...
        switch ((int) dataAccessError.val) {
            ...
            case 2:
                return new ServiceError(ServiceError.INSTANCE_LOCKED_BY_OTHER_CLIENT, "MMS DataAccessError: temporarily-unavailable");
            case 3:
            ...
            case 11:
                return new ServiceError(ServiceError.PARAMETER_VALUE_INCONSISTENT, "MMS DataAccessError: object-value-invalid");
            default:
                return new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT,
                                        "MMS DataAccessError: " + dataAccessError.val);
        }
    ...
    private static void testForErrorResponse(MmsPdu mmsResponsePdu) throws ServiceError {
        ...
        if (mmsResponsePdu.confirmedErrorPdu.serviceError.additionalDescription != null) {
            throw new ServiceError(ServiceError.UNKNOWN,
                                   "MMS confirmed error. Description: " + mmsResponsePdu.confirmedErrorPdu.serviceError
    ...
    private ConfirmedServiceResponse encodeWriteReadDecode(ConfirmedServiceRequest serviceRequest) throws ServiceError, IOException {
        ...
        ConfirmedRequestPdu confirmedRequestPdu = new ConfirmedRequestPdu(new BerInteger(currentInvokeId), serviceRequest);
    ...
    private void associate(InetAddress address, int port, InetAddress localAddr, int localPort, String authenticationParameter,
                           ClientAcseSap acseSap, int proposedMaxPduSize, int proposedMaxServOutstandingCalling, int
            proposedMaxServOutstandingCalled, int proposedDataStructureNestingLevel, byte[] servicesSupportedCalling) throws IOException {
        ...
        try {
            acseAssociation = acseSap.associate(address, port, localAddr, localPort, authenticationParameter, berOStream.getByteBuffer());
    ...
    private static MmsPdu constructInitRequestPdu(int proposedMaxPduSize, int proposedMaxServOutstandingCalling, int
            proposedMaxServOutstandingCalled, int proposedDataStructureNestingLevel, byte[] servicesSupportedCalling) {
        ...
        InitiateRequestPdu initiateRequestPdu = new InitiateRequestPdu(new BerInteger(proposedMaxPduSize),
                                                                       new BerInteger(proposedMaxServOutstandingCalling),
                                                                       new BerInteger(proposedMaxServOutstandingCalled),
                                                                       new BerInteger(proposedDataStructureNestingLevel),
                                                                       initRequestDetail);
    ...
    private void handleInitiateResponse(MmsPdu responsePdu, int proposedMaxPduSize, int proposedMaxServOutstandingCalling, int
            proposedMaxServOutstandingCalled, int proposedDataStructureNestingLevel) throws IOException {
        ...
        if (negotiatedMaxPduSize < ClientSap.MINIMUM_MMS_PDU_SIZE || negotiatedMaxPduSize > proposedMaxPduSize ||
                negotiatedMaxServOutstandingCalling > proposedMaxServOutstandingCalling || negotiatedMaxServOutstandingCalling < 0 ||
                negotiatedMaxServOutstandingCalled > proposedMaxServOutstandingCalled || negotiatedMaxServOutstandingCalled < 0 ||
                negotiatedDataStructureNestingLevel > proposedDataStructureNestingLevel || negotiatedDataStructureNestingLevel < 0) {
            acseAssociation.disconnect();
     ...
     *
     * @param sclFilePath the path to the SCL file that is to be parsed.
     * @return The ServerNode that is the root node of the complete server model.
     * @throws SclParseException if any kind of fatal error occurs in the parsing process.
     */
     ...
     * @throws IOException  if a fatal association error occurs. The association object will be closed and can no longer be used
    ...
    private ConfirmedServiceRequest constructGetServerDirectoryRequest() {
        ...
        GetNameListRequest.SubChoice_objectScope objectScope = new GetNameListRequest.SubChoice_objectScope(new BerNull(), null, null);
    ...
    private ConfirmedServiceRequest constructGetDirectoryRequest(String ldRef, String continueAfter, boolean logicalDevice) {
        ...
        if (continueAfter != "") {
            getNameListRequest = new GetNameListRequest(objectClass, objectScopeChoiceType, new BerVisibleString(continueAfter));
        } else {
    ...
    private String decodeGetDirectoryResponse(ConfirmedServiceResponse confirmedServiceResponse, List<String> lns) throws ServiceError {
        ...
        if (identifiers.size() == 0) {
            throw new ServiceError(ServiceError.INSTANCE_NOT_AVAILABLE, "decodeGetLDDirectoryResponse: Instance not available");
        }
    ...
    private LogicalNode decodeGetDataDefinitionResponse(ConfirmedServiceResponse confirmedServiceResponse, ObjectReference lnRef) throws
            ServiceError {
    ...
    private void decodeGetDataValuesResponse(ConfirmedServiceResponse confirmedServiceResponse, ModelNode modelNode) throws ServiceError {
        ...
        if (confirmedServiceResponse.read == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "Error decoding GetDataValuesReponsePdu");
        }
    ...
    private void decodeSetDataValuesResponse(ConfirmedServiceResponse confirmedServiceResponse) throws ServiceError {
        ...
        if (writeResponse == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "SetDataValuesResponse: improper response");
        }
    ...
    private void decodeAndRetrieveDsNamesAndDefinitions(ConfirmedServiceResponse confirmedServiceResponse, LogicalDevice ld) throws
            ServiceError, IOException {
    ...
    private ConfirmedServiceRequest constructGetDataSetDirectoryRequest(BerVisibleString dsId, LogicalDevice ld) throws ServiceError {
        ObjectName dataSetObj = new ObjectName(null,
                                               new ObjectName.SubSeq_domain_specific(new BerVisibleString(ld.getName().getBytes()), dsId),
                                               null);
        return new ConfirmedServiceRequest(null, null, null, null, null, dataSetObj, null);
    }

    private void decodeGetDataSetDirectoryResponse(ConfirmedServiceResponse confirmedServiceResponse, BerVisibleString dsId,
                                                   LogicalDevice ld) throws ServiceError {
        ...
        if (variables.size() == 0) {
            throw new ServiceError(ServiceError.INSTANCE_NOT_AVAILABLE, "decodeGetDataSetDirectoryResponse: Instance not available");
        }
        ...
        for (VariableDef variableDef : variables) {
            ...
            if (member == null) {
                throw new ServiceError(ServiceError.INSTANCE_NOT_AVAILABLE,
                                       "decodeGetDataSetDirectoryResponse: data set memeber does not exist, you might have to call " +
                                               "retrieveModel first");
            }
            dsMems.add(member);
        }
     ...
     * @throws ServiceError if a ServiceError is returned by the server.
     * @throws IOException  if a fatal IO error occurs. The association object will be closed and can no longer be used after
    ...
    private ConfirmedServiceRequest constructCreateDataSetRequest(DataSet dataSet) throws ServiceError {
        ...
        DefineNamedVariableListRequest.SubSeqOf_listOfVariable seqOf = new DefineNamedVariableListRequest.SubSeqOf_listOfVariable(
                listOfVariable);
        DefineNamedVariableListRequest createDSRequest = new DefineNamedVariableListRequest(dataSet.getMmsObjectName(), seqOf);
    ...
    private ConfirmedServiceRequest constructDeleteDataSetRequest(DataSet dataSet) throws ServiceError {
        ...
        DeleteNamedVariableListRequest requestDeleteDS = new DeleteNamedVariableListRequest(null, new SubSeqOf_listOfVariableListName(
                listOfVariableListName), null);
    ...
    private List<ServiceError> decodeSetDataSetValuesResponse(ConfirmedServiceResponse confirmedServiceResponse) throws ServiceError {
        ...
        if (confirmedServiceResponse.write == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "Error decoding SetDataSetValuesReponsePdu");
        }
     ...
     *                     this exception is thrown.
     */
    public List<ServiceError> setRcbValues(Rcb rcb, boolean setRptId, boolean setDatSet, boolean setOptFlds, boolean setBufTm, boolean
            setTrgOps, boolean setIntgPd, boolean setPurgeBuf, boolean setEntryId) throws IOException {
    ...
    private Report processReport(MmsPdu mmsPdu) throws ServiceError {
        ...
        if (mmsPdu.unconfirmedPdu == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "getReport: Error decoding server response");
        }
        ...
        if (listRes.get(index).success.visible_string == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "processReport: report does not contain RptID");
        }
        ...
        if (listRes.get(index).success.bit_string == null) {
            throw new ServiceError(ServiceError.FAILED_DUE_TO_COMMUNICATIONS_CONSTRAINT, "processReport: report does not contain OptFlds");
        }
        ...
        if (dataSetRef == null) {
            for (Urcb urcb : serverModel.getUrcbs()) {
                if ((urcb.getRptId() != null && urcb.getRptId().toString().equals(rptId)) || urcb.getReference().toString().equals(rptId)) {
        ...
        return new Report(rptId, optFlds, sqNum, subSqNum, moreSegmentsFollow, dataSetRef, bufOvfl, confRev, timeOfEntry, entryId,
                          inclusionBitString, reasonCodes, dataSet);
     ...
     * </ul>
     *
     * @param controlDataObject needs to be a controllable Data Object that contains a Data Attribute named "SBO".
     ...
     *
     * @param controlDataObject needs to be a controllable Data Object that contains a Data Attribute named "Oper".
     * @throws ServiceError if a ServiceError is returned by the server
     * @throws IOException  if a fatal IO error occurs. The association object will be closed and can no longer be used after
     *                      this exception is thrown.
     */
