...
public class Urcb extends Rcb {
    ...
    protected MmsPdu getMmsReport(boolean integrity, boolean gi) {
        ...
        if (integrity || gi) {
            ...
            listOfAccessResult.add(new AccessResult(null,
                                                    new Data(null, null, null, inclusionString, null, null, null, null, null, null, null,
                                                             null)));
        ...
        VariableAccessSpecification varAccSpec = new VariableAccessSpecification(null,
                                                                                 new ObjectName(new BerVisibleString("RPT"), null, null));
        ...
        return new MmsPdu(null, null, null, new UnconfirmedPdu(new UnconfirmedService(infoReport)), null, null, null, null, null);
        ...
        synchronized (this) {
            ...
            while (memberFound == null) {
                ...
                if (!(fcModelNode.parent instanceof FcModelNode)) {
                    logger.error("Unable to report Basic Data Attribute because it is not part of the referenced data set: " + bda
                            .getReference());
                    return;
                }
