...
public final class RejectPdu {
    ...
    public final static class SubChoice_rejectReason {
        ...
        public SubChoice_rejectReason(BerInteger confirmed_requestPDU, BerInteger confirmed_responsePDU, BerInteger confirmed_errorPDU,
                                      BerInteger unconfirmedPDU, BerInteger pdu_error, BerInteger cancel_requestPDU, BerInteger
                cancel_responsePDU, BerInteger cancel_errorPDU, BerInteger conclude_requestPDU, BerInteger conclude_responsePDU,
                                      BerInteger conclude_errorPDU) {
