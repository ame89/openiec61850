...
public final class BdaFloat64 extends BasicDataAttribute {
    ...
    public Double getDouble() {
        ...
        return Double.longBitsToDouble(
                ((0xffL & (value[1])) << 56) | ((0xffL & (value[2])) << 48) | ((0xffL & (value[3])) << 40) | ((0xffL & (value[4])) << 32)
                        | ((0xffL & (value[5])) << 24) | ((0xffL & (value[6])) << 16) | ((0xffL & (value[7])) << 8) | ((0xffL &
                        (value[8])) << 0));
    }
    ...
    void setValueFromMmsDataObj(Data data) throws ServiceError {
        if (data.floating_point == null || data.floating_point.octetString.length != 9) {
            throw new ServiceError(ServiceError.TYPE_CONFLICT, "expected type: floating_point as an octet string of size 9");
        }
    ...
    TypeSpecification getMmsTypeSpec() {
        return new TypeSpecification(null, null, null, null, null, null, new SubSeq_floating_point(new BerInteger(64), new BerInteger(11)),
