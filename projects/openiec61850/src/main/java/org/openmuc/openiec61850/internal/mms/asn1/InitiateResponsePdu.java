...
public final class InitiateResponsePdu {
    ...
    public InitiateResponsePdu(BerInteger localDetailCalled, BerInteger negotiatedMaxServOutstandingCalling, BerInteger
            negotiatedMaxServOutstandingCalled, BerInteger negotiatedDataStructureNestingLevel, InitResponseDetail mmsInitResponseDetail) {
        id = identifier;
