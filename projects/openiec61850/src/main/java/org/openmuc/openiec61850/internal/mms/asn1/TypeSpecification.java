...
public final class TypeSpecification {
    ...
    public TypeSpecification(SubSeq_array array, SubSeq_structure structure, BerNull boolean_, BerInteger bit_string, BerInteger integer,
                             BerInteger unsigned, SubSeq_floating_point floating_point, BerInteger octet_string, BerInteger
            visible_string, BerBoolean binary_time, BerInteger mms_string, BerNull utc_time) {
        this.array = array;
