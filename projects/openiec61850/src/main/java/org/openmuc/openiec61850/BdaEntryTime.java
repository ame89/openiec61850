...
public final class BdaEntryTime extends BasicDataAttribute {
    ...
    public void setTimestamp(long timestamp) {
        ...
        value = new byte[]{(byte) (ms >> 24), (byte) (ms >> 16), (byte) (ms >> 8), (byte) (ms), (byte) (days >> 8), (byte) days};
    }
    ...
    public long getTimestampValue() {
        ...
        return (value[0] << 24) + (value[1] << 16) + (value[2] << 8) + value[3] + ((value[4] << 8) + value[5]) * 86400000l;
    }
    ...
    TypeSpecification getMmsTypeSpec() {
        return new TypeSpecification(null, null, null, null, null, null, null, null, null, new BerBoolean(true), null, null);
    }
