...
final class ServerAssociation {
    ...
    private static String[] mmsFcs = {"MX", "ST", "CO", "CF", "DC", "SP", "SG", "RP", "LG", "BR", "GO", "GS", "SV", "SE", "EX", "SR",
            "OR", "BL"};
    ...
    private MmsPdu constructAssociationResponsePdu(InitiateRequestPdu associationRequestMMSpdu) {
        ...
        if (negotiatedMaxServOutstandingCalling > proposedMaxServOutstandingCalling && proposedMaxServOutstandingCalling > 0) {
        ...
        if (negotiatedMaxServOutstandingCalled > proposedMaxServOutstandingCalled && proposedMaxServOutstandingCalled > 0) {
        ...
        InitResponseDetail initRespDetail = new InitResponseDetail(new BerInteger(1), new BerBitString(negotiatedParameterCbbBitString,
                                                                                                       negotiatedParameterCbbBitString
                                                                                                               .length * 8 - 5),
                                                                   new BerBitString(servicesSupportedCalledBitString,
                                                                                    servicesSupportedCalledBitString.length * 8 - 3));

        InitiateResponsePdu initRespPdu = new InitiateResponsePdu(new BerInteger(negotiatedMaxPduSize),
                                                                  new BerInteger(negotiatedMaxServOutstandingCalling),
                                                                  new BerInteger(negotiatedMaxServOutstandingCalled),
    ...
    private MmsPdu createServiceErrorResponse(ServiceError e, int invokeId) {
        ...
        switch (e.getErrorCode()) {
            ...
            case ServiceError.INSTANCE_NOT_AVAILABLE:
                errClass = new SubChoice_errorClass(null, null, null, null, null, null, null, new BerInteger(e.getErrorCode()), null, null,
                                                    null, null, null);
                break;
            case ServiceError.INSTANCE_IN_USE:
                errClass = new SubChoice_errorClass(null, null, new BerInteger(e.getErrorCode()), null, null, null, null, null, null, null,
                                                    null, null, null);
                break;
            ...
            case ServiceError.INSTANCE_LOCKED_BY_OTHER_CLIENT:
                errClass = new SubChoice_errorClass(null, null, null, null, null, null, null, null, null, null, null, new BerInteger(2),
                                                    null);
                break;
            case ServiceError.TYPE_CONFLICT:
                errClass = new SubChoice_errorClass(null, null, null, null, null, null, null, null, null, null, null, new BerInteger(4),
                                                    null);
                break;
            default:
                errClass = new SubChoice_errorClass(null, null, null, null, null, null, null, null, null, null, null, null,
        ...
        MmsPdu mmsPdu = new MmsPdu(null, null, new ConfirmedErrorPdu(new BerInteger(invokeId), null, asn1ServiceError), null, null, null,
                                   null, null, null);
     ...
     */
    private GetVariableAccessAttributesResponse handleGetVariableAccessAttributesRequest(GetVariableAccessAttributesRequest
        ...
        if (index1 != -1) {
            ...
            if (index2 != -1) {
                ...
                if (index1 == -1) {
                    ...
                    while (index2 != -1) {
                        ...
                        if (subNode == null) {
                            throw new ServiceError(ServiceError.INSTANCE_NOT_AVAILABLE,
                                                   "GetVariableAccessAttributes (GetDataDefinition): no object with domainId " +
                                                           getVariableAccessAttributesRequest.name.domain_specific.domainId + " and " +
                                                           "ItemID " + getVariableAccessAttributesRequest.name.domain_specific.itemId + "" +
                                                           " was found.");
                        }
                        index1 = index2;
                        index2 = itemIdString.indexOf('$', index1 + 2);
                ...
                for (ModelNode child : fcDataObjects) {
                    doStructComponents.add(new StructComponent(new BerVisibleString(child.getName().getBytes()), child.getMmsTypeSpec()));
                }
                ...
                return new GetVariableAccessAttributesResponse(new BerBoolean(false),
                                                               new TypeSpecification(null, struct, null, null, null, null, null, null, null,
                                                                                     null, null, null));
        ...
        for (String mmsFc : mmsFcs) {
            ...
            if (fc != null) {
                ...
                TypeSpecification fcTypeSpec = new TypeSpecification(null, struct, null, null, null, null, null, null, null, null, null,
                                                                     null);
        ...
        TypeSpecification typeSpec = new TypeSpecification(null, struct, null, null, null, null, null, null, null, null, null, null);
    ...
    private ReadResponse handleGetDataValuesRequest(ReadRequest mmsReadRequest) throws ServiceError {
        ...
        if (mmsReadRequest.specificationWithResult == null || mmsReadRequest.specificationWithResult.val == false) {
            ...
            if (dataSetReference == null) {
                throw new ServiceError(ServiceError.PARAMETER_VALUE_INCONSISTENT, "handleGetDataSetValuesRequest: DataSet name incorrect");
            }
    ...
    private AccessResult getReadResult(FcModelNode modelNode) {
        ...
        if (modelNode.getFc() == Fc.CO && modelNode.getName().equals("SBO")) {
            ...
            if (!cdcParent.select(this, serverSap.timer)) {
                return new AccessResult(null, new Data(null, null, null, null, null, null, null, null, new BerVisibleString(""), null, null,
                                                       null));
            }
            return new AccessResult(null,
                                    new Data(null, null, null, null, null, null, null, null, new BerVisibleString("success"), null, null,
                                             null));
            // }
            // else {
    ...
    private WriteResponse handleSetDataValuesRequest(WriteRequest mmsWriteRequest) throws ServiceError {
        ...
        if (variableAccessSpecification.listOfVariable != null) {
            ...
            if (listOfVariable.size() < 1 || listOfData.size() < 1 || listOfVariable.size() != listOfData.size()) {
                throw new ServiceError(ServiceError.PARAMETER_VALUE_INCONSISTENT,
                                       "handleSetDataValuesRequest: less than one variableAccessSpecification or data element is not " +
                                               "allowed, or listOfData ne listOfVar");
            }
            ...
            throw new ServiceError(ServiceError.PARAMETER_VALUE_INAPPROPRIATE, "handleSetDataValuesRequest: invalid MMS request");
        }

        return new WriteResponse(mmsResponseValues);
    }

    private void writeAndFillMissingWriteResults(List<WriteResponse.SubChoice> mmsResponseValues, List<BasicDataAttribute>
            totalBdasToBeWritten, int[] numBdas) {
        int i;
                    ...
                    if (mmsResponseIterator.next() == null) {
                        for (int j = 0; j < numBdas[i]; j++) {
                            ...
                            if (serviceError != null) {
                                mmsResponseIterator
                                        .set(new WriteResponse.SubChoice(new BerInteger(serviceErrorToMmsError(serviceError)), null));
                            } else {
                                bda.mirror.setValueFrom(bda);
                            }
                        }
    ...
    private void getFirstWriteResults(List<WriteResponse.SubChoice> mmsResponseValues, List<BasicDataAttribute> totalBdasToBeWritten,
                                      int[] numBdas, int i, FcModelNode dataSetMember, Data mmsData) {
        ...
        if (fc == Fc.CO) {
            ...
            synchronized (urcb) {
                if (nodeName.equals("RptEna")) {
                    ...
                    if ((urcb.reserved == null || urcb.reserved == this) && !urcb.enabled) {
                        if (!((BdaOptFlds) modelNode).isBufferOverflow() && !((BdaOptFlds) modelNode)
                                .isConfigRevision() && !((BdaOptFlds) modelNode).isDataReference() && !((BdaOptFlds) modelNode)
                                .isEntryId()) {
                            ((BasicDataAttribute) modelNode).setValueFrom((BasicDataAttribute) fcModelNodeCopy);
                            return writeSuccess;
                        } else {
                    ...
                    if ((urcb.reserved == this) && urcb.enabled && ((BdaTriggerConditions) urcb.getChild("TrgOps"))
                ...
                } else if (nodeName.equals("RptID") || nodeName.equals("BufTm") || nodeName.equals("TrgOps") || nodeName.equals("IntgPd")) {
                    if ((urcb.reserved == null || urcb.reserved == this) && !urcb.enabled) {
                        ((BasicDataAttribute) modelNode).setValueFrom((BasicDataAttribute) fcModelNodeCopy);
                        return writeSuccess;
                    } else {
    ...
    private GetNamedVariableListAttributesResponse handleGetDataSetDirectoryRequest(ObjectName mmsGetNamedVarListAttReq) throws ServiceError {
        ...
        if (dataSet == null) {
            throw new ServiceError(ServiceError.PARAMETER_VALUE_INAPPROPRIATE, "DataSet with that reference is does not exist.");
        }
    ...
    private static String convertToDataSetReference(ObjectName mmsObjectName) {
        if (mmsObjectName.domain_specific != null) {
            return mmsObjectName.domain_specific.domainId.toString() + "/" + mmsObjectName.domain_specific.itemId.toString()
                                                                                                                 .replace('$', '.');
    ...
    private BerNull handleCreateDataSetRequest(DefineNamedVariableListRequest mmsDefineNamedVariableListRequest) throws ServiceError {
        ...
        if (dataSetReference.startsWith("@")) {
            if (nonPersistentDataSets.containsKey(dataSetReference)) {
                throw new ServiceError(ServiceError.PARAMETER_VALUE_INAPPROPRIATE, "data set with that name exists already");
            }
    ...
    private DeleteNamedVariableListResponse handleDeleteDataSetRequest(DeleteNamedVariableListRequest mmsDelNamVarListReq) throws ServiceError {
