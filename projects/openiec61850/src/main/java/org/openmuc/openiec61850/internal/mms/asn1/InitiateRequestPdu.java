...
public final class InitiateRequestPdu {
    ...
    public InitiateRequestPdu(BerInteger localDetailCalling, BerInteger proposedMaxServOutstandingCalling, BerInteger
            proposedMaxServOutstandingCalled, BerInteger proposedDataStructureNestingLevel, InitRequestDetail mmsInitRequestDetail) {
        id = identifier;
