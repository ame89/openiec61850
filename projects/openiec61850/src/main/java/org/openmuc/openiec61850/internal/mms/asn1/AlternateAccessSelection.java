...
public final class AlternateAccessSelection {
    ...
    public final static class SubSeq_selectAlternateAccess {
        ...
        public SubSeq_selectAlternateAccess(BerVisibleString component, BerInteger index, SubSeq_indexRange indexRange, BerNull
                allElements, AlternateAccess alternateAccess) {
            id = identifier;
    ...
    public AlternateAccessSelection(SubSeq_selectAlternateAccess selectAlternateAccess, BerVisibleString component, BerInteger index,
                                    IndexRangeSeq indexRange, BerNull allElements) {
