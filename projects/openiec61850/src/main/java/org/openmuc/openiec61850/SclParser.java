...
import org.openmuc.openiec61850.internal.scl.*;
...
final class SclParser {
                ...
                if (doName != "") {
                    ...
                    if (fcdaNode == null) {
                        throw new SclParseException(
                                "Specified FCDA: " + objectReference + " in DataSet: " + nameAttribute + " not found in Model.");
                    }
     ...
     */
    private FcModelNode createDataAttribute(String ref, Fc fc, AbstractDataAttribute dattr, Node iXmlNode, boolean dchg, boolean dupd,
                                            boolean qchg) throws SclParseException {
        ...
        if (!bType.equals("Struct")) {
            ...
            for (Bda bda : datype.bdas) {
                ...
                subDataAttributes.add(createDataAttribute(ref + '.' + bda.getName(), fc, bda, iNodeFound, dchg, dupd, qchg));
            }
